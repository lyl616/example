...
exports.default = {
    ...
    methods: {
        ...
        clearData: function clearData() {
            ...
            self.$nextTick(function () {
                self.dispatchEvent('load-success', null);
                self.broadcastEvent('load-success', self.tablePagination);
    ...
    events: {
        ...
        'vuetable:refresh': function vuetableRefresh() {
            this.currentPage = 1;
            this.loadData();
        },'vuetable:clear': function vuetableClear() {
            this.clearData();
        },
