/*!
 * Bootstrap-treetable v1.2.5
 *
 * Copyright 2017 by huang-lin@neusoft.com
...
(function ($) {
    ...
    BootstrapTreeTable.VERSION = '1.2.5';
        ...
        setbranch: function (element) {
            ...
            if (element.data('leaf') === 0) {
                ...
                if (this.options.leafIcon) {
                    $span = $(this.options.leafIcon).css({'padding-left': '17px', 'padding-right': '5px'});
                } else {
                ...
                if (id === nodeid) {
                    ...
                    if (children.length === 0) {
                        ...
                        if (that.options.leafIcon) {
                            $span = $(that.options.leafIcon).css({'padding-left': '17px', 'padding-right': '5px'});
                        } else {
                            $span = $('<span></span>').css('padding-left', '17px');
                        }
                        $td.prepend($span);
