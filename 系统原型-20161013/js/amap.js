    ...
    btn: function () {
        ...
        $("#btn-jjy").click(function () {
           ...
           // marker_beijing.setAnimation(BMAP_ANIMATION_BOUNCE); //跳动的动画
            ...
            var scontent = "<span></span></br>";
            scontent += "<span style='font-weight:bold;'>SO2：</span><span>63.46</span></br>";
            scontent += "<span style='font-weight:bold;'>NOX：</span><span>106.86</span></br>";
            scontent += "<span style='font-weight:bold;'>VOC：</span><span>0.74</span></br>";
			scontent += "<span style='font-weight:bold;'>PM10：</span><span>9.48</span></br>";
            scontent += "<span style='font-weight:bold;'>Pm2.5：</span><span>5.83</span></br>";
            scontent += "<span style='font-weight:bold;'>OC：</span><span>0.08</span></br>";
            scontent += "<span style='font-weight:bold;'>BC：</span><span>0.09</span></br>";
            var infoWindow = new BMap.InfoWindow(scontent, opts);  // 创建信息窗口对象 
            marker_tianjing.addEventListener("mouseover", function () {
                map.openInfoWindow(infoWindow, new BMap.Point(117.200165, 39.103228)); //开启信息窗口
            });
            ...
            var scontent = "<span></span></br>";
            scontent += "<span style='font-weight:bold;'>SO2：</span><span>201.23</span></br>";
            scontent += "<span style='font-weight:bold;'>NOX：</span><span>418.98</span></br>";
            scontent += "<span style='font-weight:bold;'>VOC：</span><span>4.75</span></br>";
			scontent += "<span style='font-weight:bold;'>PM10：</span><span>53.6</span></br>";
            scontent += "<span style='font-weight:bold;'>Pm2.5：</span><span>32.33</span></br>";
            scontent += "<span style='font-weight:bold;'>OC：</span><span>1.25</span></br>";
            scontent += "<span style='font-weight:bold;'>BC：</span><span>0.70</span></br>";
            var infoWindow = new BMap.InfoWindow(scontent, opts);  // 创建信息窗口对象 
            marker_shijiazhuang.addEventListener("mouseover", function () {
                map.openInfoWindow(infoWindow, new BMap.Point(114.524277, 38.053458)); //开启信息窗口
            }); 
        ...
        $("#btn-beijing").click(function () {
            ...
            var infoWindow = new BMap.InfoWindow(scontent, opts);  // 创建信息窗口对象 
            marker_beijing.addEventListener("mouseover", function () {
                map.openInfoWindow(infoWindow, new BMap.Point(116.403406,39.924121)); //开启信息窗口
            });
            ...
            scontent += "<span style='font-weight:bold;'>BC：</span><span>0.08</span></br>";
            var infoWindow = new BMap.InfoWindow(scontent, opts);  // 创建信息窗口对象 
            marker_beijing_station01.addEventListener("mouseover", function () {
                map.openInfoWindow(infoWindow, new BMap.Point(116.494099,39.920137)); //开启信息窗口
            });
           ...
           //marker_beijing_station02.setAnimation(BMAP_ANIMATION_BOUNCE); //跳动的动画
            ...
            scontent += "<span style='font-weight:bold;'>BC：</span><span>0.08</span></br>";
            var infoWindow = new BMap.InfoWindow(scontent, opts);  // 创建信息窗口对象 
            marker_beijing_station02.addEventListener("mouseover", function () {
                map.openInfoWindow(infoWindow, new BMap.Point(116.283968,39.853811)); //开启信息窗口
            });
