			...
			<div class="top-search-container">
				<div class="form-inline">
					<form role="form">
						...
						<div class="form-group">
							<label class="m-l-20 m-r-5">浓度类型</label>
							<b id="divcte">
                        <select name="category" id="s_concentrationType" class="form-control"></select>
                    </b>
						</div>
						<div class="form-group pull-right">
							<button type="button" class="btn btn-md btn-info pull-right" onclick="tab.ajax.reload()">搜索</button>
						</div>
					</form>
				</div>
			</div>
			<div class="m-t-10 bgf pd10">
				<div class="table-responsive" id="scrollObj">
					<div id="topPlugin" class="hide" role="group">
						<%--<sec:authorize access="hasRole('ROLE_FUN_006_04_01_01')">--%>
						<button type="button" class="btn btn-danger m-r-5" onclick="del()">批量删除</button>
						<%--</sec:authorize>--%>
						<%--<sec:authorize access="hasRole('ROLE_FUN_006_04_01_02')">--%>
						<button type="button" id="addBtn" class="btn btn-info " onclick="showAddModal()">新增</button>
						<%--</sec:authorize>--%>
						<%--<sec:authorize access="hasRole('ROLE_FUN_006_04_01_03')">--%>
				...
				<div class="modal-content">
					...
					<div class="modal-body ovh">
						<form class="form-horizontal" id="addForm" method="post">
							...
							<div class="col-sm-6 m-t-10">
								<div class="form-group">
									<label class="m-r-5 form-label text-right" for="threshold">阈值</label>
									<input type="text" class="form-control" id="threshold" name="threshold">
								</div>
							</div>
							<div class="col-sm-6 m-t-10">
								<div class="form-group">
									<label class="m-r-5 form-label text-right" for="warnType">告警类型</label>
									<select name="warnType" id="warnType" class="form-control">
										<option value="1">浓度超标</option>
							...
							<div class="col-sm-6 m-t-10">
								<div class="form-group">
									<label class="m-r-5 form-label text-right" for="signType">比较符号</label>
							...
							<div class="col-sm-12 m-t-10">
								<div class="form-group">
									...
									<textarea id="messageContent" style="width: 388px;" name="messageContent" class="form-control" rows="3"></textarea>
								</div>
							</div>
							<div class="clear"></div>
							<div class="col-sm-6 m-t-10">
					...
					<div class="modal-footer clear m-t-10">
							...
							<button type="button" class="btn btn-info" onclick="add()">保存</button>						</div>
				</div>
			</div>
		</div>
