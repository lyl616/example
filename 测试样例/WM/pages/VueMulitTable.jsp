...
<link rel="stylesheet" href="${ctx}/resources/plugins/vue-easytable/css/easytable.css"> <!--修改-->
...
<script src="${ctx}/resources/plugins/vue-easytable/js/easytable.js"></script> <!--修改-->
