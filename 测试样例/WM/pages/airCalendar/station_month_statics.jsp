...
<div class="pd10">
    <div class="top-search-container">
        <div class="form-inline">
            <div class="form-group">
                <label class="m-l-10 m-r-5">
                    <font color="red">*</font>时间</label> <input type="text" class="form-control  Wdate" onFocus="WdatePicker({dateFmt:'yyyy-MM',maxDate:'%y-%M'})" id="startTime" name="startTime" placeholder="DateTime">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label class="m-l-20 m-r-5" for="conType"><font color="red">*</font>污染物</label>
                <select class="form-control" name="account" id="conType">
                    <option value="aqi">AQI</option>
                    <option value="pm25" selected=true>PM25</option>
                </select>
            </div>
    ...
    <div id="fs" class="m-t-10 bgf">
        <div class="col-md-10 m-t-10">
            <div id="level_table_title" class="row text-center lh200 m-b-10 f-s-14"></div>
        </div>
...
<script type="text/javascript" src="${ctx }/resources/js/analysis/station_month_statics.js"></script>
