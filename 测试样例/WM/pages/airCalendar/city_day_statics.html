...
<html lang="en">
	...
	<body class="ovh">
				...
				<div class="top-search-container">
					<div class="form-inline">
						<div class="form-group">
							...
							<input type="text" class="form-control  Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM'})" id="startTime" name="startTime" placeholder="Date Start">
						</div>
						<div class="form-group">
							<label class="m-l-10 m-r-5"><font color="red">*</font>设备类型</label>
						...
						<div class="form-group pull-right">
							<input type="button" class="btn btn-info pull-right" onclick="queryCalendar()" value="查询">
							...
							<tbody>
								<tr>
									...
									<td style="padding-right: 5px;">
										<table border="0" cellpadding="0" id="dayCalStatic" cellspacing="0" style="overflow-x: hidden; border-collapse: collapse; border: none; width: 100%; height: 100%;">
											<tbody>
												<tr>
													<td colspan="31" id="tab-title00" class="f-s-12 tc" style="height: 50px;">
														<div class="col-md-10">
		...
		<script type="text/javascript" src="${ctx }/resources/js/analysis/city_day_statics.js"></script>
