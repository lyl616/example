...
<html lang="en">
			...
			<div class="Map-All">
				...
				<div class="post-top-nav">
					...
					<div class="btn-group pull-right">
                        ...
                        <span>  风向 ：</span> <i class="g0f85c9 fsn" id="direction"> <img src="${ctx }/resources/img/airdata/N1.png" width="50" height="45"></i><span id="directName">N</span>
                    </button>
						</div>
						<div class="btn-group s-5 pull-right">
							<button type="button" class="btn btn-white">
				...
				<img src="${ctx}/resources/img/copyright.png" width="290" height="20">
			</div>-->
				<!-- 底部播放栏开始 -->
	...
	<script type="text/javascript" src="${ctx}/resources/js/airMonitoring/pollutionCloud.js"></script>
