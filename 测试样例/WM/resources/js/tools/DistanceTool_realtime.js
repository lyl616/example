...
(function() {
    ...
    DistanceTool.prototype._bind = function(){
        ...
        if (this._startFollowText) {
            ...
            this._followTitle.setStyle({color : "#333", borderColor : "#ff0103", fontSize : "45px"});
        }
    };
    ...
    DistanceTool.prototype._processLastOp = function() {
        ...
        pt.disLabel.setStyle({color: "#333", borderColor: "#ff0103", fontSize: "45px"});
    ...
    DistanceTool.prototype._formatTitle = function(type, text, distance, label){
        ...
        title.setStyle({"lineHeight" : "60px", "zIndex" : "85", "padding" : "3px 5px"});
