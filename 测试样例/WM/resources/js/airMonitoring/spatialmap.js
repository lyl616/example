...
// spatialmap.get("legend").update(data.max, data.unit);
		...
		SpatialMap.prototype = {
			configure : function(config) {
				...
				me.set("gradient", config.gradient || { 0: "rgb(0,228,0)", 0.20: "rgb(255,255,0)", 0.40: "rgb(255,120,0)", 0.60: "rgb(255,0,0)", 0.80: "rgb(150,0,76)", 1.0: "rgb(141,30,60)"});    // default is the common blue to red gradient
...
// }
			...
			interpolate : function(data, image, startColor, endColor, width, height) {
				...
				/**
				 * 插值矩阵数据,时间复杂度O(height*width*len) 当height = 356, width = 673, len = 26时为6229288
				 */
