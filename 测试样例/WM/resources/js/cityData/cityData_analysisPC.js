...
function requestData() {
    ...
    $.ajax({
        ...
        success: function (data) {
            $("#stationChartsDiv").hide();
            $("#level_tab_h_div").hide();
...
function weatherLevelCharts(data) {
    ...
    var option = {
        ...
        //color: ['#a6d089','#ffd82d','#fea04e','#da5359','#ba3379','#9c014d'],
        series: [{
            name: '空气质量',
            type: 'pie',
            radius: '70%',
...
function aqiTendency(data) {
    var myChart = echarts.init(document.getElementById('aqi_tendency_charts')),
        pd = getParamData();
    var colomW = 91.9; //图例中，单个的宽度为91.9像素
