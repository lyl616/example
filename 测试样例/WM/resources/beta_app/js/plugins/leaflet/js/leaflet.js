		...
		function() {
			...
			_setIconStyles: function(t, e) {
				var i, n = this.options,
					s = o.point(n[e + "Size"]);
				i = "shadow" === e ? o.point(n.shadowAnchor || n.iconAnchor) : o.point(n.iconAnchor), !i && s && (i = s.divideBy(2, !0)), t.className = "leaflet-marker-" + e + " " + n.className, i , s && (t.style.width = s.x + "px", t.style.height = s.y + "px")
			},
			...
			_updateLayout: function() {
				...
				var i = t.offsetWidth;
				i = Math.min(i, this.options.maxWidth), i = Math.max(i, this.options.minWidth), e.whiteSpace = "", e.height = "";
...
//				zoomOutTitle: "缩小1111"
			...
			onAdd: function(t) {
				var e = "leaflet-control-zoom leaflet-zoom-setposition",
