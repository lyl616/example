...
var chart = {
  ...
  perspectiveOffsetX: 3,
  perspectiveOffsetY: 1.5,

  chartHeight: 130,
  lineWidth: 450,
  lineHeight: 10,

  bodyHeight: 100, // Scroll height
  windowHeight: 0,
  scrollScale: null,
  ...
  initChart: function() {
    ...
    years
      .append('line')
      .classed('end', true)
      .attr('x1', this.xScale(z_index))
      .attr('y1', this.yScale(0))
      .attr('x2', this.xScale(z_index))
      .attr('y2', function(d) {return that.yScale(d.data[z_index]);});

    years
      .append('text')
      .classed('label', true)
      .attr('x', this.xScale(z_index) + 5)
...
//d3.json('../resources/plugins/d3/data/temp.json', function(temperatureData) {
//});
