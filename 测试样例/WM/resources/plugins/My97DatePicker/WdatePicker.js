 ...
 */
var $dp, WdatePicker, bigScreen_flg = false;
(function () {
    var $ = {
        $langList: [
            ...
            function C() {
                ...
                for (var C = 0; C < D.length; C++) {
                    if (bigScreen_flg) {
                        ...
                        if (D[C].name == J.skin) $.push("<link rel=\"stylesheet\" type=\"text/css\" href=\"" + A + "skin/" + D[C].name + "/datepicker-big.css\" charset=\"" + D[C].charset + "\"/>");
                    }
                    else {
