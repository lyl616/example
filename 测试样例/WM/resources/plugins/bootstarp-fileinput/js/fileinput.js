...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        defaultFileActionSettings = {
            ...
            removeClass: 'btn btn-xs btn-white',
            removeTitle: 'Remove file',
            uploadIcon: '<i class="glyphicon glyphicon-upload text-info"></i>',
            uploadClass: 'btn btn-xs btn-white',
    ...
    FileInput.prototype = {
        ...
        raise: function (event, params) {
            ...
            switch (event) {
                // ignore these events
                case 'filebatchuploadcomplete': //上传文件状态为完成
                case 'filebatchuploadsuccess'://上传文件成功
                case 'fileuploaded':
                case 'fileclear':
                case 'filecleared':
                case 'filereset':
                case 'fileerror'://异步上传错误结果处理
