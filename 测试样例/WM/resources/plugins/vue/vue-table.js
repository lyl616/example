(function e(t, n, r) {
    ...
    3: [function (require, module, exports) {
        ...
        exports.default = {
            ...
            methods: {
                    ...
                    this.fields.forEach(function (field, i) {
                        if (typeof field === 'string') {
                            ...
                            obj = {
                                ...
                                callbackitem: field.callbackitem === undefined ? false : field.callbackitem
                            };
                        }
                ...
                getAllQueryParams: function getAllQueryParams() {
                    ...
                    //            var params = ['pageNo=0','length=' + this.perPage].join('&');
                ...
                toggleCheckbox: function toggleCheckbox(target, dataItem, fieldName) {
                    var self = this;
                    var isChecked = target.checked;
                    var idColumn = self.extractArgs(fieldName);
                    ...
                    if (isChecked) {
                        if (self.chkNum != 0) {
                            if (self.selectedTo.length >= self.chkNum) {
                ...
                toggleAllCheckboxes: function toggleAllCheckboxes(target, fieldName) {
                    var self = this;
                    var isChecked = target.checked;
        ...
        var vuetablehtml = '<div class="{{wrapperClass}}">' +
            ...
            '							<th v-if="extractName(field.name) == \'__checkbox\'" :class="[field.titleClass, \'checkbox_\'+extractArgs(field.name)]"> <input type="checkbox" @change="toggleAllCheckboxes($event.target, field.name)" :checked="checkCheckboxesState(field.name)"> </th>' +
            ...
            '								<td v-if="extractName(field.name) == \'__checkbox\'" class="vuetable-checkboxes {{field.dataClass}}"> <input type="checkbox" @change="toggleCheckbox($event.target, item, field.name)" :checked="rowSelected(item, field.name)"> </td>' +
