...
// v8 likes predictible objects
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            (function (setImmediate) {
                ...
                /* WEBPACK VAR INJECTION */
            }.call(exports, __webpack_require__(44).setImmediate))
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            if (Component.options.functional) {
                console.error("[vue-loader] Vuetable.vue: functional components are not supported with templates, they should use render functions.")
            }
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            if (Component.options.functional) {
                console.error("[vue-loader] VuetablePagination.vue: functional components are not supported with templates, they should use render functions.")
            }
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            if (Component.options.functional) {
                console.error("[vue-loader] VuetablePaginationDropdown.vue: functional components are not supported with templates, they should use render functions.")
            }
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            if (Component.options.functional) {
                console.error("[vue-loader] VuetablePaginationInfo.vue: functional components are not supported with templates, they should use render functions.")
            }
...
// btoa polyfill for IE<10 courtesy https://github.com/davidchambers/Base64.js
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0_axios__ = __webpack_require__(16);
            /* harmony import */
            ...
            __webpack_exports__["default"] = ({
                ...
                methods: {
                    ...
                    getFieldDataClass: function getFieldDataClass(item, field){
                    	if (typeof field.dataClass === 'function'){
                    		return field.dataClass(this.getObjectValue(item, field.name), item);
                    	}

                        var args = field.dataClass.split('|');
                        var func = args.shift();

                        if (typeof this.$parent[func] === 'function') {
                            var value = this.getObjectValue(item, field.name);

                            return args.length > 0 ? this.$parent[func].apply(this.$parent, [value, item].concat(args)) : this.$parent[func].call(this.$parent, value, item);
                        }
                        return typeof field.dataClass === 'undefined' ? '' : field.dataClass;
                    },
                    ...
                    loadData: function loadData() {
                        ...
                        this.fetch(this.apiUrl, this.httpOptions['params']).then(success, failed).catch(function () {
                            return failed();
                        });
                    },
                    ...
                    callCallback: function callCallback(field, item) {
                        ...
                        if (typeof this.$parent[func] === 'function') {
                            ...
                            return args.length > 0 ?
                                this.$parent[func].apply(this.$parent, [value].concat(args),data)
                                : this.$parent[func].call(this.$parent, value,data);
                        }
                    ...
                    onTableClass: function onTableClass() {
                    	//debugger
                        if (this.tableClassCallback !== '') {
                            this.warn('"table-class-callback" prop is deprecated, please use "table-class" prop instead.');
                            return;
                        }

                        if (typeof this.tableClass === 'function') {
                            return this.tableClass();
                        }

                        return  this.css.tableClass;
                    },
                    ...
                    onCellMouseEnter: function onCellMouseEnter(dataItem, field, event) {
                        this.$emit(this.eventPrefix + 'cell-mouseenter', dataItem, field, event);
                    },
                    onCellMouseLeave: function onCellMouseLeave(dataItem, field, event) {
                        this.$emit(this.eventPrefix + 'cell-mouseleave', dataItem, field, event);
                    },
                ...
                watch: {
                    ...
                    'selectedTo': function (newVal, oldVal) {
                        Event.$emit('selectedToIds', this.selectedTo);
                    }
                }
            });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            Object.defineProperty(__webpack_exports__, "__esModule", {value: true});
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__VuetablePaginationMixin_vue__ = __webpack_require__(2);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__VuetablePaginationMixin_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__VuetablePaginationMixin_vue__);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            Object.defineProperty(__webpack_exports__, "__esModule", {value: true});
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__VuetablePaginationInfoMixin_vue__ = __webpack_require__(4);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__VuetablePaginationInfoMixin_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__VuetablePaginationInfoMixin_vue__);
                    ...
                    css: {
                        ...
                        default: function _default() {
                            return {
                                ...
                                paginationInfoClass: 'floated aligned six wide column',
                                dropdownClass: 'ui search dropdown',
                                icons: {
                                    first: 'angle double icon',
                                    prev: 'chevron icon',
                                    next: 'chevron icon',
                                    last: 'angle double icon'
                                }
                            };
                        }
                    },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__components_Vuetable_vue__ = __webpack_require__(12);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_0__components_Vuetable_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_Vuetable_vue__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__components_VuetablePagination_vue__ = __webpack_require__(13);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_1__components_VuetablePagination_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_VuetablePagination_vue__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__components_VuetablePaginationDropdown_vue__ = __webpack_require__(14);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_2__components_VuetablePaginationDropdown_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__components_VuetablePaginationDropdown_vue__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_3__components_VuetablePaginationInfo_vue__ = __webpack_require__(15);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_3__components_VuetablePaginationInfo_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__components_VuetablePaginationInfo_vue__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_4__components_VuetablePaginationMixin_vue__ = __webpack_require__(2);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_4__components_VuetablePaginationMixin_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4__components_VuetablePaginationMixin_vue__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_5__components_VuetablePaginationInfoMixin_vue__ = __webpack_require__(4);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_5__components_VuetablePaginationInfoMixin_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5__components_VuetablePaginationInfoMixin_vue__);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_6_promise_polyfill__ = __webpack_require__(11);
            /* harmony import */
            var __WEBPACK_IMPORTED_MODULE_6_promise_polyfill___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_promise_polyfill__);
            /* harmony reexport (default from non-hamory) */
            __webpack_require__.d(__webpack_exports__, "Vuetable", function () {
                return __WEBPACK_IMPORTED_MODULE_0__components_Vuetable_vue___default.a;
            });
            /* harmony reexport (default from non-hamory) */
            __webpack_require__.d(__webpack_exports__, "VuetablePagination", function () {
                return __WEBPACK_IMPORTED_MODULE_1__components_VuetablePagination_vue___default.a;
            });
            /* harmony reexport (default from non-hamory) */
            __webpack_require__.d(__webpack_exports__, "VuetablePaginationDropDown", function () {
                return __WEBPACK_IMPORTED_MODULE_2__components_VuetablePaginationDropdown_vue___default.a;
            });
            /* harmony reexport (default from non-hamory) */
            __webpack_require__.d(__webpack_exports__, "VuetablePaginationInfo", function () {
                return __WEBPACK_IMPORTED_MODULE_3__components_VuetablePaginationInfo_vue___default.a;
            });
            /* harmony reexport (default from non-hamory) */
            __webpack_require__.d(__webpack_exports__, "VuetablePaginationMixin", function () {
                return __WEBPACK_IMPORTED_MODULE_4__components_VuetablePaginationMixin_vue___default.a;
            });
            /* harmony reexport (default from non-hamory) */
            __webpack_require__.d(__webpack_exports__, "VuetablePaginationInfoMixin", function () {
                return __WEBPACK_IMPORTED_MODULE_5__components_VuetablePaginationInfoMixin_vue___default.a;
            });
            ...
            /* harmony default export */
            __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_0__components_Vuetable_vue___default.a);
...
// Adapted from convert-source-map (MIT)
        ...
        /***/ (function (module, exports, __webpack_require__) {
            ...
            (function (global, process) {
                ...
                /* WEBPACK VAR INJECTION */
            }.call(exports, __webpack_require__(52), __webpack_require__(10)))
            ...
            module.exports = {
                render: function () {
                    ...
                    return (_vm.isFixedHeader) ? _c('div', [_c('div', {
                        ...
                        class: ['vuetable', _vm.onTableClass(), _vm.css.tableBodyClass]
                        ...
                        return [_c('tr', {
                            ...
                            return [(field.visible) ? [(_vm.isSpecialField(field.name)) ? [(_vm.extractName(field.name) == '__sequence') ? _c('td', {
                                class: ['vuetable-sequence', _vm.getFieldDataClass(item, field)],
                                domProps: {
                                    "innerHTML": _vm._s(_vm.renderSequence(index))
                                }
                            }) : _vm._e(), _vm._v(" "), (_vm.extractName(field.name) == '__handle') ? _c('td', {
                                class: ['vuetable-handle', _vm.getFieldDataClass(item, field)],
                                domProps: {
                                ...
                                class: ['vuetable-checkboxes', _vm.getFieldDataClass(item, field)]
                            }, [_c('input', {
                                attrs: {
                                    "type": "checkbox"
                                },
                                ...
                                class: ['vuetable-component', _vm.getFieldDataClass(item, field)]
                                ...
                                class: ['vuetable-slot', _vm.getFieldDataClass(item, field)]
                            }, [_vm._t(_vm.extractArgs(field.name), null, {
                                rowData: item,
                                rowIndex: index,
                                rowField: field.sortField
                            })], 2) : _vm._e()] : [_c('td', {
                                class: _vm.getFieldDataClass(item, field),
                                domProps: {
                                ...
                                on: {
                                    ...
                                    "mouseenter": function ($event) {
                                        _vm.onCellMouseEnter(item, field, $event)
                                    },
                                    "mouseleave": function ($event) {
                                        _vm.onCellMouseLeave(item, field, $event)
                                    }
                                }
                            })]] : _vm._e()]
                        ...
                        class: ['vuetable', _vm.onTableClass()]
                    }, [_c('thead', [_c('tr', [_vm._l((_vm.tableFields), function (field) {
                        return [(field.visible) ? [(_vm.isSpecialField(field.name)) ? [(_vm.extractName(field.name) == '__checkbox') ? _c('th', {
                            class: ['vuetable-th-checkbox-' + _vm.trackBy, field.titleClass],
                            style: ({
            ...
            module.exports = {
                render: function () {
                    ...
                    return _c('div', {
                        ...
                        class: ['btn-white', _vm.css.linkClass, _vm.isOnFirstPage ? _vm.css.disabledClass : ''],
                        on: {
                            "click": function ($event) {
                                _vm.loadPage(1)
                            }
                        ...
                        class: ['btn-white', _vm.css.linkClass, _vm.isOnLastPage ? _vm.css.disabledClass : ''],
                        on: {
                            "click": function ($event) {
                                _vm.loadPage('next')
                            }
