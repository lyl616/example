function getControlHrmlContent() {
	var html = '<div id="controlbox" >' +
		'<div id="boxcontainer" class="searchbox searchbox-shadow" > ' +
		'	<div>' +
		'		 <input id="searchboxinput" type="text" placeholder="请输入城市名" style="position: relative;"/>' +
		'	</div>' +
		...
		onAdd: function(a) {
			...
			setTimeout(function() {			
				$("#searchbox-searchbutton").click(function() {
					...
					$('.searchbox .btn-tooltip').show();
					setTimeout(function(){
						$('.searchbox .btn-tooltip').hide();
					},2000);
					//c(a)
				});
